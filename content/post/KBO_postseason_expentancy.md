...
> <img src="https://i1.wp.com/lopes.hufs.ac.kr/wordpress/wp-content/uploads/2018/08/1_form.png?resize=624%2C86" width="600">
...
> <img src="https://i0.wp.com/lopes.hufs.ac.kr/wordpress/wp-content/uploads/2018/08/2_form.png?resize=624%2C158" width="300">
...
전처리 함수로 처리한 데이터를 승률을 구하는 함수에 넣어서 해당 팀의 정규시즌 승, 패, 무, 승률을 계산합니다. 승률 함수는 전처리 함수에서 만든 경기결과 열을 통해 해당 팀의 승리, 패배, 무승부(있는 경우에만)를 가지고 승률 공식에 대입하여 계산하는 역할을 합니다. 현재 적용되는 승률 공식은 승리한 경기 수 + 패배한 경기 수에서 승리한 경기 수로 나누어 주는 것입니다.
