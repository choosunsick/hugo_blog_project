...
> 오클랜드(2001): 884^2 / (884^2 + 645^2) = 0.6525 (2001년 실제 승률은 0.6296)  
...
이제 제가 수집한 자료를 R로 읽어와 보겠습니다.
다음은 2017년 자료를 열어서 읽어오는 코드입니다.
...
읽어온 자료에서 정규시즌과 시범경기 올스타전을 제외한 경기만 뽑아줍니다.
이어서 그 자료에서 홈팀과 원정팀을 뽑아 고유한 리스트로 만들어줍니다.
결과를 보시면 "NC", "롯데", "두산","기아", "SK"의 2017년도 포스트시즌 진출 5개팀을 확인할 수 있습니다.
...
이제 같은 방식으로 앞서 구한 전년도 포스트시즌 진출한 ["NC","롯데","두산","기아","SK"] 5개 팀 모두의 승률을 구해줍니다.
5개 팀의 승률을 구하면 그것의 평균을 구해줍니다. 과정과 결과는 다음과 같습니다.
...
전년도인 2017년도에 현재 상위 5개팀의 총득점과 총실점을 구해본다. 구하는 방법은 작년의 데이터를 기대 승률 함수에 적용한다.
결과는 다음과 같다. 책에서와 같이 여기서 구한 총실점을 이번년도 총실점에도 그러할 것이라 가정한다.
